...
const APP_ID = 'taas-as-service-2';
const instanceId = MFEController.getInstanceId() || `taasmfe2`;
...
export const rootConfig = {
  mount: async (container, appProps) => {
    console.log('React 16 - container ', container);
    console.log('React 16 - appProps ', appProps);
...
window.onload = () => {
  ...
  rootConfig.mount(container, {
      ...appProps,
      title: 'test',
      instanceId: appProps.instanceId ?? 'taasmfe2',
  });
};